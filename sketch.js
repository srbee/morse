...
function bh1(){
 ...
 //myMorse(1)
   if(cbox.checked()==true){myMorse(this.elt.value)}
...
function mySliders(){
  ...
  spd_slider.position(50,130)
  spd_slider.changed(spdHandler)
  // freq slider
  freq_slider=createSlider(400,2000,600,10)
  freq_slider.position(200,130)
...
function bh2(){
   if(cbox.checked()==true){myMessage('cq=cq=cq=d=e=v=u=2=s=r=b=v=u=2=s=r=b=v=u=2=s=r=b=a=r=k')}
}//end of function button handler 2 bh3()
function bh3(){
   if(cbox.checked()==true){myMessage('sos sos sos sos')}
}//end of function button handler 2 bh3()
